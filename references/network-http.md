...
class HttpUtil {
    ...
    // 构建请求头
    private buildHeader(): IHttpHeader {
    ...
    // GET
    async get<T>(url: string, params?: IQueryParam[]): Promise<T> {
        let fullUrl = url
